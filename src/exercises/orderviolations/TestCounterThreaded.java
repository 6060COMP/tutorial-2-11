 ...
 * <BR>
 * -the sequential variant - creates three simple times-table printers for 2, 5
 * and 10 respectively. It then executes each printer sequentially. This
 * produces output for 2, then 5, then 10.<BR>
 * <BR>
 * -the threaded variant (THIS) - creates three simple times-table printers for
 * 2, 5 and 10 respectively. It then executes each printer concurrently -
 * resulting in a predictably unpredictable output order.<BR>
 * <BR>
 ...
 * @author david
 */
public class TestCounterThreaded extends Thread {

  // This is the main method; this runs first
  public static void main(String[] args) {
    TestCounterThreaded two = new TestCounterThreaded(2);
    TestCounterThreaded fiver = new TestCounterThreaded(5);
    TestCounterThreaded tenner = new TestCounterThreaded(10);
  ...
  public TestCounterThreaded(int increment) {
